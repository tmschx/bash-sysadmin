...
IMG_C_PRIMARY="#FFFFFF"		# Primary colour for transparent background; Potrace uses black by default.
IMG_C_SECONDARY="#195594"	# Secondary colour, used for backgrounds; Potrace uses transparent by default.
