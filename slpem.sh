...
##
## Arguments:
##  <certificate> : name of the certificate without extension
##
...
set -u
CA="skyCA"                                      # Name of the CA
DIR_CRT="certs"                                 # Directory with the certificates
DIR_KEY="private"                               # Directory with the private keys
...
PEM_FILENAME="./${DIR_KEY}/${CERTIFICATE}.pem"  # Output pem file
